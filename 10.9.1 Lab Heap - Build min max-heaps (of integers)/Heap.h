...
private:
    ...
    void _reHeapUp(int lastndx, int compare(int, int));
    void _reHeapDown(int rootndx, int compare(int, int));
...
public:
    ...
    bool insertHeap(int itemIn, int compare(int, int));
    bool deleteHeap(int& itemOut, int compare(int, int));
