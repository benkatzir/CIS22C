...
void BinaryTree::_postOrder(Node *root) const
{
    if (root)
    {
        _postOrder(root->left);         // Traverse the left subtree
        _postOrder(root->right);        // Traverse the right subtree
        cout << root->data.num << " "; // Visit the root
    }
}
...
void BinaryTree::_preOrder(Node *root) const
{
    ...
    {
        cout << root->data.num << " "; // Visit the root
        _preOrder(root->left);         // Traverse the left subtree
        _preOrder(root->right);        // Traverse the right subtree
    }
}
